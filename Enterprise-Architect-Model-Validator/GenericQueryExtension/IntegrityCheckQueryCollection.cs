...
namespace GenericExtension
{
    ...
    [ExportMetadata("Name", "Integrity Check")]
    [ExportMetadata("Description", "Collection of Integrity check SQL queries from Enterprise Architect.")]
    internal class IntegrityCheckQueryCollection : IQueryCollection
    {
        public string Path
        {
            get
