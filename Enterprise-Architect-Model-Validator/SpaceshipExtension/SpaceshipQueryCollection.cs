...
namespace SpaceshipExtension
{
    ...
    [ExportMetadata("Name", "SpaceML Requirements")]
    [ExportMetadata("Description", "Collection of Spaceship (TM) requirements SQL queries.")]
    internal class SpaceshipQueryCollection : IQueryCollection
    {
        public string Path
        {
            get
